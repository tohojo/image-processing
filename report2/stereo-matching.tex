...
\begin{figure}[p]
 ...
 \subfloat[Tsukuba (ideal)] { \label{fig:tsu-4} \includegraphics[trim = -2mm -2mm -2mm -2mm, width=0.23\textwidth]{stereo/tsu_imL_mat0_hardmult_smooth0.9.png} }
 \subfloat[Venus (ideal)] { \label{fig:ven-4} \includegraphics[trim = -2mm -2mm -2mm -2mm, width=0.23\textwidth]{stereo/ven_imL_mat0_hardmult_smooth0.9.png} }
 \subfloat[Cones (ideal)] { \label{fig:con-4} \includegraphics[trim = -2mm -2mm -2mm -2mm, width=0.23\textwidth]{stereo/con_imL_mat0_hardmult_smooth0.9.png} }
 \subfloat[Teddy (ideal)] { \label{fig:ted-4} \includegraphics[trim = -2mm -2mm -2mm -2mm, width=0.23\textwidth]{stereo/ted_imL_mat0_hardmult_smooth0.9.png} }
